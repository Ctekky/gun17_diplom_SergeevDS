...
namespace Metroidvania.Enemy
{
    ...
    {
        [Header("Move State")] public float movementVelocity = 3f;

        public float minMovementTimer = 2f;
        public float maxMovementTimer = 5f;

        [Header("Check Variables")] public float wallCheckDistance = 0.5f;
        public float ledgeCheckDistance = 0.2f;
        public LayerMask groundLayer;

        [Header("Idle State")] public float minIdleTime = 1f;
        public float maxIdleTime = 4f;

        [Header("Detected State")] public float minAggroDistance = 3f;
        public float maxAggroDistance = 4f;
        public float actionTime = 1.5f;
        public LayerMask playerLayer;

        [Header("Enemy Charge State")] public float chargeVelocity = 6f;
        ...
        [Header("Enemy Attack State")] public float closeRangeActionDistance = 1f;
        ...
        [Header("Enemy dead state")] public GameObject deathParticles;
    }
}